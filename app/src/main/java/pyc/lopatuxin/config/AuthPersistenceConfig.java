...
@EnableJpaRepositories(
        basePackages = "pyc.lopatuxin.auth.repository",
...
public class AuthPersistenceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean authEntityManagerFactory(DataSource dataSource) {
        LocalContainerEntityManagerFactoryBean emf = new LocalContainerEntityManagerFactoryBean();
        emf.setDataSource(dataSource);
        emf.setPackagesToScan("pyc.lopatuxin.auth.entity");
        emf.setPersistenceUnitName("auth");
        emf.setJpaVendorAdapter(new HibernateJpaVendorAdapter());
        Map<String, Object> props = new HashMap<>();
        props.put("hibernate.default_schema", "auth");
    ...
    public SpringLiquibase authLiquibase(DataSource dataSource) {
        ...
        lb.setChangeLog("classpath:db/changelog/auth/db.changelog-master.yml");
        lb.setDefaultSchema("auth");
        lb.setLiquibaseSchema("auth");
        return lb;
    }
}
